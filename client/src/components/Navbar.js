...
class Navbar extends Component {
    ...
    render() {
        ...
        // 인증된 경우 이미지 보여줌 
        const authLinks = (
            <form className="navbar-nav ml-auto" style={{fontFamily: 'sans-serif', fontSize: '1.5vw'}}>
      ...
      const guestLinks = (
        ...
        return(
            <form class="navbar navbar-expand-lg navbar-dark bg-primary" style={{fontFamily: 'sans-serif'}}>
                {/* <nav> */}
