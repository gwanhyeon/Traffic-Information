...
class BoradRead extends Component {
    ...
    render () {
        ...
        return(
            <form style={{margin: 'auto', width: '50%', marginTop: '50px'}}>
                <h4 style={{marginBottom: '2px', fontSize: '1.5rem'}}>title</h4>
                <p  name="board_title"  className="form-control" style = {{width: '100%', fontSize: '5rem', fontSize: '1.5rem'}}>
                {/* 글 제목 */}
                {this.state.board_title}
                </p>
                <p/>
                <h4 style={{marginBottom: '2px', fontSize: '1.5rem'}}>content</h4>
                <p name="board_contents" className="form-control" style = {{width: '100%', height: '300px', fontSize: '1.5rem'}}>
                {/* 글 내용 */}
    ...
    // 글쓴이 != 로그인 유저
        ...
        return(
            <form style={{margin: 'auto', width: '50%', marginTop: '50px'}}>
                <h4 style={{marginBottom: '2px',  fontSize: '1.5rem'}}>title</h4>
                <p  name="board_title"  className="form-control" style = {{width: '100%', fontSize: '1.5rem'}}>
                {/* 글 제목 */}
                {this.state.board_title}
                </p>
                <p/>
